          ...
          <div class="flex justify-between items-center">
            ...
            <div class="hidden lg:flex items-center space-x-4">
              ...
              <div class="flex items-center space-x-2">
                ...
                <RouterLink to="/cart"
                  class="header-widget hidden xl:hidden 2xl:hidden lg:flex  relative  items-center justify-center w-10 h-10 bg-gray-100 hover:bg-pink-500 text-gray-600 hover:text-white rounded-lg transition-all duration-300"
                  title="Wishlist">
...
import { Search, X, ShoppingBasket, Heart, Shuffle } from 'lucide-vue-next'
